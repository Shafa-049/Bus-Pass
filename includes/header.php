        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/bus_pass_seusl/index.php#routes">Routes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/bus_pass_seusl/index.php#about">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/bus_pass_seusl/index.php#contact">Contact</a>
                    </li>
                </ul>
                <div class="d-flex">
