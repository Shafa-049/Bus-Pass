...
CREATE TABLE IF NOT EXISTS buses (
    ...
    bus_type ENUM('normal', 'semi_luxury', 'luxury', 'ac') NOT NULL,
...
CREATE TABLE IF NOT EXISTS bus_schedules (
    ...
    campus_to_home_departure TIME DEFAULT NULL,
    campus_to_home_arrival TIME DEFAULT NULL,
    status ENUM('active', 'inactive') DEFAULT 'active',
    days VARCHAR(50) NOT NULL COMMENT 'Comma-separated days of operation (e.g., monday,tuesday,wednesday)',
    depot_id INT NOT NULL,
...
CREATE INDEX idx_bus_schedules_depot ON bus_schedules(depot_id);
CREATE INDEX idx_bus_schedules_route ON bus_schedules(route_id);
CREATE INDEX idx_bus_schedules_dates ON bus_schedules(valid_from, valid_to);
