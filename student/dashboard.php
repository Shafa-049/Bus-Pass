...
// Set page title
$page_title = "Student Dashboard | SEUSL Bus Pass";
...
<div class="container-fluid">
    <div class="row">
        <!-- Sidebar -->
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-teal sidebar collapse">
            <div class="position-sticky pt-3">
                <div class="text-center mb-4">
                    <div class="profile-img mb-3">
                        <img src="<?php echo !empty($student['profile_image']) ? '../uploads/profiles/'.$student['profile_image'] : '../assets/img/default-avatar.png'; ?>" 
                             class="rounded-circle" width="100" height="100" alt="Profile Image">
                    </div>
                    <h5 class="text-white"><?php echo htmlspecialchars($student['full_name']); ?></h5>
                    <p class="text-white-50 small"><?php echo htmlspecialchars($student['registration_no']); ?></p>
                </div>
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="bus-passes.php">
                            <i class="fas fa-ticket-alt me-2"></i>
                            My Bus Passes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="apply-pass.php">
                            <i class="fas fa-plus-circle me-2"></i>
                            Apply for New Pass
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="renew-pass.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="notifications.php">
                            ...
                            <?php if(count($notifications) > 0): ?>
                                <span class="badge bg-danger rounded-pill float-end"><?php echo count($notifications); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card text-white bg-primary h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="card-title">Active Bus Pass</h6>
                                    <h2 class="mb-0">
                            ...
                            <?php else: ?>
                                <a href="apply-pass.php" class="btn btn-sm btn-light mt-2">Apply Now</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <?php if($active_pass): ?>
                                <div class="text-center mb-3">
                                    <div class="bus-pass-preview p-3 border rounded" style="background: #f8f9fa;">
