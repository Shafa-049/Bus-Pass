...
<main>
    <!-- About Section -->
    <section id="about" class="py-5" style="padding-top: 100px; padding-bottom: 6rem; position: relative; z-index: 1; scroll-margin-top: 80px;">
        <div class="container" style="position: relative;">
            <div class="text-center mb-4" style="padding-top: 30px;">
                <h2 class="fw-bold" style="color: var(--primary-dark); font-size: 2.25rem; position: relative; padding-bottom: 15px; margin-bottom: 40px;">
                    <span style="position: relative; z-index: 1; background: #e0f2f1; padding: 0 30px; border-radius: 20px;">About Our Service</span>
                    <span style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 80px; height: 3px; background: var(--primary-color); border-radius: 3px;"></span>
                </h2>
            </div>
    ...
    <!-- Routes Section -->
    <section id="routes" class="py-5" style="padding-top: 2rem; padding-bottom: 5rem; margin-top: -2rem;">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="fw-bold" style="color: var(--primary-dark); font-size: 2.25rem; position: relative; padding-bottom: 15px; margin-bottom: 40px;">
                    <span style="position: relative; z-index: 1; background: #e0f2f1; padding: 0 30px; border-radius: 20px;">Available Routes & Fares</span>
                    <span style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 80px; height: 3px; background: var(--primary-color); border-radius: 3px;"></span>
                </h2>
            </div>
            <div class="row g-4">
                ...
                foreach ($routes as $route) {
                    ...
                    echo '<div class="card h-100 border-0 rounded-4 overflow-hidden shadow-lg position-relative" style="transition: all 0.3s ease; border: none; background: linear-gradient(145deg, #ffffff 0%, #f8fafc 100%);">';
                    echo '<div class="position-absolute top-0 end-0 p-3">';
                    echo '<div class="bg-white rounded-circle shadow-sm" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">';
                    echo '<i class="fas fa-bus" style="color: var(--primary-color);"></i>';
                    echo '</div>';
                    echo '</div>';
                    echo '<div class="card-body p-4">';
                    echo '<div class="mb-4">';
                    echo '<div class="d-flex align-items-center mb-3">';
                    echo '<div class="bg-primary bg-opacity-10 p-2 rounded-3 me-3" style="min-width: 48px; height: 48px; display: flex; align-items: center; justify-content: center;">';
                    echo '<i class="fas fa-map-marker-alt" style="color: var(--primary-color); font-size: 1.25rem;"></i>';
                    echo '</div>';
                    echo '<div>';
                    echo '<h5 class="mb-0 fw-bold" style="color: var(--primary-dark);">' . htmlspecialchars($route['from']) . '</h5>';
                    echo '<div class="text-muted small">Departure</div>';
                    echo '</div>';
                    echo '</div>';
                    echo '<div class="d-flex align-items-center mb-3">';
                    echo '<div class="bg-primary bg-opacity-10 p-2 rounded-3 me-3" style="min-width: 48px; height: 48px; display: flex; align-items: center; justify-content: center;">';
                    ...
                    echo '</div>';
                    echo '<div>';
                    echo '<h5 class="mb-0 fw-bold" style="color: var(--primary-dark);">' . htmlspecialchars($route['to']) . '</h5>';
                    echo '<div class="text-muted small">Destination</div>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                    echo '<div class="d-flex justify-content-between align-items-center pt-3 border-top">';
                    echo '<div class="d-flex align-items-center">';
                    echo '<i class="fas fa-route me-2" style="color: var(--primary-color);"></i>';
                    echo '<span class="text-muted">' . htmlspecialchars($route['distance']) . ' • ' . htmlspecialchars($route['time']) . '</span>';
                    echo '</div>';
                    echo '<a href="#" class="btn btn-sm px-4 py-2" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-dark) 100%); color: white; border-radius: 30px; font-weight: 500; box-shadow: 0 4px 15px rgba(13, 148, 136, 0.2); transition: all 0.3s ease; border: none;">';
                    echo '<i class="fas fa-clock me-1"></i> Schedule';
                    echo '</a>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <h5>SEUSL Transport Division</h5>
                                <p class="mb-1"><i class="fas fa-map-marker-alt me-2 text-teal"></i> Oluvil, Sri Lanka</p>
                                <p class="mb-1"><i class="fas fa-phone me-2 text-teal"></i> +94 67 2260000</p>
                                <p class="mb-1"><i class="fas fa-envelope me-2 text-teal"></i> transport@seusl.lk</p>
                            </div>
                            <div class="ratio ratio-16x9">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.527621403473!2d81.84783831477433!3d7.02948299490512!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3afca5a6ff3b6e17%3A0x5d2c6f5b5d1f3f1f!2sSouth%20Eastern%20University%20of%20Sri%20Lanka!5e0!3m2!1sen!2slk!4v1620000000000!5m2!1sen!2slk" 
